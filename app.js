...
async function loadBranches() {
    ...
    data.forEach(branch => {
        ...
        card.innerHTML = `
            ...
            <button onclick="deleteBranch('${branch.id}')" class="btn-delete">🗑️ Delete</button>
        `;
        card.onclick = (e) => {
...
async function loadSemesters(branchId) {
    ...
    data.forEach(semester => {
        ...
        card.innerHTML = `
            ...
            <button onclick="deleteSemester('${semester.id}')" class="btn-delete">🗑️ Delete</button>
        `;
        card.onclick = (e) => {
            if (!e.target.classList.contains('btn-delete')) {
...
async function loadSections(semesterId) {
    ...
    data.forEach(section => {
        ...
        item.innerHTML = `
            <h4>${section.name}</h4>
            <button onclick="deleteSection('${section.id}')" class="btn-delete">🗑️ Delete</button>
        `;
...
async function searchContent() {
    ...
    data.forEach(doc => {
        ...
        item.innerHTML = `
            ...
            <button onclick="deleteDocument('${doc.id}')" class="btn-delete">🗑️ Delete</button>
        `;
